<div class="vis--row vis--header">

  <span class="vis--row_title vis--header_item">Company</span>

  <span class="vis--header_score vis--header_item">Score %</span>
